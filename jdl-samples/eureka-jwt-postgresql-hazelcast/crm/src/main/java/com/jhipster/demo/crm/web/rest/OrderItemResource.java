...
public class OrderItemResource {
    ...
    public ResponseEntity<List<OrderItem>> searchOrderItems(@RequestParam String query, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
