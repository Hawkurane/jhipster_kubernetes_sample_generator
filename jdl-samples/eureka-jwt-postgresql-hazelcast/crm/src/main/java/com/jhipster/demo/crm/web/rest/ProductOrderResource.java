...
public class ProductOrderResource {
    ...
    public ResponseEntity<List<ProductOrder>> searchProductOrders(@RequestParam String query, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
